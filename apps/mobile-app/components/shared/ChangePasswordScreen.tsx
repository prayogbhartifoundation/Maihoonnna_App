...
export function ChangePasswordSharedScreen() {
    ...
    const handleSendOtp = async () => {
        setLoading(true);
        try {
            // Read phone directly from stored userData for global reuse
            const userDataStr = await AsyncStorage.getItem('userData');
            if (!userDataStr) throw new Error('User profile not found. Please log in again.');
            const userData = JSON.parse(userDataStr);
            if (!userData.phone) throw new Error('Phone number not found in profile.');
    ...
    const handleSelectCurrentPassword = () => {
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/auth/change-password`, {
                ...
                body: JSON.stringify({
                    ...
                    otp: verificationMethod === 'otp' ? otp : undefined,
            ...
            case 'choose':
                return (
                    <View style={styles.section}>
                        ...
                        <TouchableOpacity style={styles.optionCard} onPress={handleSelectCurrentPassword}>

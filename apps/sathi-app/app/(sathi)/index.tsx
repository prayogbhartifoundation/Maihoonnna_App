            ...
            return (
              <View key={item.id} style={[styles.requestCard, { padding: scale(16), marginBottom: scale(16) }]}>
                <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
                  <Image source={{ uri: item.photo }} style={{ width: scale(56), height: scale(56), borderRadius: scale(12), marginRight: scale(14) }} />
                  <View style={{ flex: 1 }}>
            ...
            return (
              <View key={item.id} style={[styles.requestCard, { padding: scale(16), marginBottom: scale(16) }]}>
                <View style={{ flexDirection: 'row', alignItems: 'flex-start', marginBottom: scale(16) }}>
                  <Image source={{ uri: item.photo }} style={{ width: scale(65), height: scale(65), borderRadius: scale(12), marginRight: scale(16) }} />

                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input
                      ...
                      onChange={(event) => setPersonalField('mobileNumber', event.target.value)}
                      placeholder="Mobile number"
                      className="w-full px-4 py-3 rounded-2xl bg-[#F4EAE3]/30 border border-[#E7DED6] focus:outline-none focus:border-[#FF7A00]"
                    />
                    <input
                      value={formState.personal.whatsappNumber}
                      onChange={(event) => setPersonalField('whatsappNumber', event.target.value)}
                    ...
                    <input
                      ...
                      onChange={(event) => setPersonalField('alternatePhone', event.target.value)}
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      ...
                      onChange={(event) => setPersonalField('aadhaarNumber', event.target.value)}
                      placeholder="Aadhaar number"
                      className="w-full px-4 py-3 rounded-2xl bg-[#F4EAE3]/30 border border-[#E7DED6] focus:outline-none focus:border-[#FF7A00]"
                    />
                    <input
                      value={formState.personal.panNumber}
                      onChange={(event) => setPersonalField('panNumber', event.target.value.toUpperCase())}
